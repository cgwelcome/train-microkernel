...
void track_set_branch_direction(uint32_t switch_id, int8_t direction) {
    ...
    TrackNode *branch = track_find_branch(switch_id);
    if (branch != NULL) {
...
TrackNode *track_find_next_sensor(TrackNode *node) {
    ...
    TrackNode *current = track_find_next_node(node);
    while (current != NULL && current->type != NODE_SENSOR) {
        current = track_find_next_node(current);
    }
    return current;
}
...
uint32_t track_find_next_sensor_dist(TrackNode *node) {
    ...
    uint32_t dist = track_find_next_node_dist(node);
    TrackNode *current = track_find_next_node(node);
    while (current != NULL && current->type != NODE_SENSOR) {
        dist += track_find_next_node_dist(current);
        current = track_find_next_node(current);
    }
    return dist;
}
...
void track_position_reverse(TrackPosition *current) {
    uint32_t dist = track_find_next_node_dist(current->node);
    assert(current->dist <= dist);
    current->node = track_find_next_node(current->node)->reverse;
...
void track_position_move(TrackPosition *current, int32_t offset) {
    if (offset == 0) return;
    if (offset < 0) {
        track_position_reverse(current);
        track_position_move(current, -offset);
        track_position_reverse(current);
        return;
    }
    current->dist += (uint32_t) offset;
    while (current->dist >= track_find_next_node_dist(current->node)) {
        current->dist -= track_find_next_node_dist(current->node);
        current->node = track_find_next_node(current->node);
    }
}
...
static void track_init_a(TrackNode *track) {
  ...
  track[100].num = 11;
  track[100].broken = 0;
  track[100].direction = DIR_CURVED;
  ...
  track[102].num = 12;
  track[102].broken = 0;
  track[102].direction = DIR_CURVED;
  ...
  track[104].num = 13;
  track[104].broken = 0;
  track[104].direction = DIR_CURVED;
  ...
  track[106].num = 14;
  track[106].broken = 0;
  track[106].direction = DIR_CURVED;
  ...
  track[108].num = 15;
  track[108].broken = 0;
  track[108].direction = DIR_CURVED;
  ...
  track[110].num = 16;
  track[110].broken = 0;
  track[110].direction = DIR_CURVED;
  ...
  track[112].num = 17;
  track[112].broken = 0;
  track[112].direction = DIR_CURVED;
  ...
  track[114].num = 18;
  track[114].broken = 0;
  track[114].direction = DIR_CURVED;
  ...
  track[116].num = 153;
  track[116].broken = 0;
  track[116].direction = DIR_CURVED;
  ...
  track[118].num = 154;
  track[118].broken = 0;
  track[118].direction = DIR_CURVED;
  ...
  track[120].num = 155;
  track[120].broken = 0;
  track[120].direction = DIR_CURVED;
...
static void track_init_b(TrackNode *track) {
  ...
  track[122].num = 156;
  track[122].broken = 1;
  track[122].direction = DIR_STRAIGHT;
  track[122].reverse = &track[123];
  track[122].edge[DIR_STRAIGHT].reverse = &track[121].edge[DIR_AHEAD];
  track[122].edge[DIR_STRAIGHT].src = &track[122];
  track[122].edge[DIR_STRAIGHT].dest = &track[120];
